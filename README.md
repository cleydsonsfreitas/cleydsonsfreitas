...
Atualmente sou graduando no 3º semestre de **Segurança da Informação** na **Fatec Araraquara** e atuo ativamente na liderança acadêmica como **AWS Student Builder Group Leader (SBGL)**([https://builder.aws.com/](https://builder.aws.com/profile?tab=badges)).
